...
(12, 1, 1, 1, '2025-10-22 16:22:19'),
(12, 5, 3, 1, '2025-10-22 16:22:15');
...
CREATE TABLE `stock_columns` (
  ...
  `bloqueado` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0=desbloqueado, 1=bloqueado',
  `created_at` datetime DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `stock_columns` (`id`, `name`, `tipo`, `bloqueado`, `created_at`) VALUES
(14, 'Ingreso 17/10/2025', 'ingreso', 0, '2025-10-17 17:17:19'),
(17, 'Ingreso 17/10/2025', 'ingreso', 0, '2025-10-17 17:38:33'),
(18, 'Ingreso 17/10/2025', 'ingreso', 0, '2025-10-17 17:38:40'),
(21, 'Ingreso 17/10/2025', 'ingreso', 0, '2025-10-17 17:38:45'),
(23, 'Ingreso 17/10/2025', 'ingreso', 0, '2025-10-17 17:38:49'),
(25, 'Ingreso 17/10/2025', 'ingreso', 0, '2025-10-17 17:39:17'),
(26, 'Egreso 28/10/2025', 'egreso', 0, '2025-10-28 22:47:14'),
(27, 'Egreso 29/10/2025', 'egreso', 0, '2025-10-29 18:59:02');
...
(6, 'Pepe higienica', 'pepepepito@gmail.coma', '$2y$10$c3LxObTjaEQWa3xQ94E.K.IuFwzkw/xjNDSq.u7jgRLzmoArb2lTu', 'administrador', '1762976664_f788f34444b1239cdb95.jpg', '2025-08-29 21:17:40'),
...
INSERT INTO `ventas_detalle` (`detalle_id`, `venta_id`, `libro_id`, `cantidad`, `precio_unitario`, `subtotal`) VALUES
(1, 1, 1, 2, 123.00, 246.00),
(2, 1, 3, 1, 4000.00, 4000.00),
(3, 1, 7, 1, 123.00, 123.00),
(4, 1, 8, 1, 123345.00, 123345.00),
(5, 2, 2, 1, 123123.00, 123123.00),
(6, 2, 5, 2, 23423.00, 46846.00);

-- --------------------------------------------------------

--
-- Table structure for table `ventas_maestro`
--
...
CREATE TABLE `ventas_maestro` (
  ...
  `met_pago` enum('efectivo','transferencia') NOT NULL,
  `estado` enum('pendiente','revisado','cancelado') NOT NULL DEFAULT 'pendiente',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `ventas_maestro`
--

INSERT INTO `ventas_maestro` (`venta_id`, `comprador_id`, `fecha_de_pago`, `total_venta`, `comprobante`, `met_pago`, `estado`, `created_at`) VALUES
(1, 12, '2025-01-14', 6500.00, 'imgs/1757697604_adf71dcd8ef402ce55c1.webp', 'efectivo', 'pendiente', '2025-11-14 17:29:07'),
(2, 12, '2025-01-15', 9000.00, NULL, 'efectivo', 'pendiente', '2025-11-14 17:29:07');
...
--
-- Indexes for table `ventas_maestro`
--
...
--
-- AUTO_INCREMENT for table `ventas_maestro`
--
ALTER TABLE `ventas_maestro`
...
--
-- Constraints for table `ventas_maestro`
--
ALTER TABLE `ventas_maestro`
